...
function loadUsers(url, containerId, specificHandler) {
    $.ajax({
        url: url,
        type: 'GET',
        headers: {
        ...
        success: function (response) {
            ...
            $.get("/components/user.html", function (data) {
                ...
                $.each(response.data, function (i, user) {
                    ...
                    specificHandler(newElement, user); // Call the specific handler for additional handling
