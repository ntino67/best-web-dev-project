...
{
    private CompanyLocationModel $model;
    ...
    public function __construct(string $id_company)
    {
        ...
        $this->model = new CompanyLocationModel();
    }
    ...
    private function processRessourceRequest(string $method, string $id): void
    {
        ...
        if (!$data) {
            ...
            echo json_encode(["message" => "Location $id not found for company $this->id_company"]);
            return;
        }
        ...
        switch ($method) {
            ...
            case "DELETE" :
                $affectedRows = $this->model->delete($id, $this->id_company);
                echo json_encode([
                    "message" => "City $id deleted for company $this->id_company",
                    "rows" => $affectedRows
                ]);
                break;
