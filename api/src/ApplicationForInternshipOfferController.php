...
class ApplicationForInternshipOfferController
{
    private ApplicationForInternshipOfferModel $model;
    ...
    public function __construct(string $id_internship_offer)
    {
        ...
        $this->model = new ApplicationForInternshipOfferModel();
    }
    ...
    private function processRessourceRequest(string $method, string $id) : void
    {
        ...
        if (!$data) {
            ...
            echo json_encode(["message" => "Application $id not found for internship $this->id_internship_offer"]);
            return;
        }
        ...
        switch($method) {
            ...
            case "DELETE" :
                ...
                echo json_encode([
                    "message" => "Application $id deleted for internship $this->id_internship_offer",
                    "rows" => $affectedRows
                ]);
                break;
    ...
    public static function checkData(array $data, $errorCode) : void
    {
        $pattern = array(
            ...
            "CV" => DataValidator::NAME,
            "motivation_letter" => DataValidator::NAME
        );
